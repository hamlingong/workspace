 ...
 * HttpUtils
 * <ul>
 * <strong>Http get, you can also use {@link cn.trinea.android.common.service.HttpCache}</strong>
 * <li>{@link #httpGet(cn.trinea.android.common.entity.HttpRequest)} http get synchronous</li>
 * <li>{@link #httpGet(String)} http get synchronous</li>
 * <li>{@link #httpGetString(String)} http get synchronous, response is String</li>
 * <li>{@link #httpGet(cn.trinea.android.common.entity.HttpRequest, cn.trinea.android.common.util.HttpUtils.HttpListener)} http get asynchronous</li>
 ...
 * <li>{@link #httpPost(cn.trinea.android.common.entity.HttpRequest)}</li>
...
public class HttpUtils {
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see cn.trinea.android.common.util.HttpUtils#httpGet(cn.trinea.android.common.entity.HttpRequest)
     */
     ...
     * <li>If you want get data synchronous, use {@link #httpGet(cn.trinea.android.common.entity.HttpRequest)} or {@link #httpGetString(cn.trinea.android.common.entity.HttpRequest)}</li>
     * </ul>
     * 
     * @param url
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see cn.trinea.android.common.util.HttpUtils#httpPost(cn.trinea.android.common.entity.HttpRequest)
     */
