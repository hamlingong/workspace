 ...
 * before</li>
 * <li>{@link #setOnDropDownListener(cn.trinea.android.common.view.DropDownListView.OnDropDownListener)} set listener which will be excuted when drop down, but you
